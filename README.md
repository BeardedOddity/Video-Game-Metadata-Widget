...
If you need to move to a different machine or clear your keys, use the Wipe Clean button in the Dashboard. This will wipe all local data and reset the system to factory defaults.
